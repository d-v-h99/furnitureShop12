...
import com.hoangdoviet.furnitureshop.activities.LoginRegisterActivity
import com.hoangdoviet.furnitureshop.databinding.FragmentProfileBinding
import com.hoangdoviet.furnitureshop.util.Resource
import com.hoangdoviet.furnitureshop.viewmodel.ProfileViewModel
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.linearAllOrders.setOnClickListener {
            findNavController().navigate(R.id.action_profileFragment_to_allOrdersFragment3)
        }
